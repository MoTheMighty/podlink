...
<html lang="en-US"itemscope itemtype="http://schema.org/medicalcondition">
  <head>
    ...
    <meta property="twitter:account_id" content=""/>
        ...
        <!-- fb -->
        <meta name="og:title" content="Peroneal Tendons | Why does the side of my ankle hurt?"/>
        <meta name="og:url" content=""/>
        <meta name="og:description" content="Peroneal tendon problems occur either from repetitive use injuries such as running, tennis, cycling or from a sudden injury such as an ankle sprain or fracture."/>
...
<ul class="nav nav-tabs nav-justified" style="margin: 20px 0px;">
            ...
            <div class="tab-content" style="padding: 0px 60px;">
              ...
              <div class="tab-pane fade" id="signs_symptoms">
                  <p><strong>Symptoms include:</strong></p> <ul> <li itemprop="signorsymptom">Swelling around the outside of the ankle</li> <li itemprop="signorsymptom">Redness and warmth</li> <li itemprop="signorsymptom">Pain with walking, running or moving the foot from side to side</li> </ul> <p>When you damage the peroneal tendons from an acute injury, it may not be readily apparent as there is generally other injuries which are the primary focus, such as torn ligaments in the case of an ankle sprain.</p> <p><strong>Symptoms include:</strong></p> <ul> <li itemprop="signorsymptom">Swelling around the outside of the ankle</li> <li>Redness and warmth</li> <li itemprop="signorsymptom">Pain with walking, running or moving the foot from side to side</li> <li itemprop="signorsymptom">Instability or weakness the foot of ankle</li> <li>Inability to pivot</li> </ul>
              </div>
              <!-- tab -->
