  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
      ...
      <meta property="twitter:account_id" content="By far the most common cause, accounting for 95% of all cases, is abnormal, repetitive stresses placed on the anatomic structures of the foot and leg resulting in injury and inflammation. This condition is known as plantar fasciitis."/>
        ...
        <!-- fb -->
        <meta name="og:title" content="Plantar Fasciitis - Heel Pain"/>
        ...
        <!-- Google+ -->
        <meta itemprop="name" content="Plantar Fasciitis - Heel Pain"/>
    ...
    <ul class="nav nav-tabs nav-justified" style="margin: 20px 0px;">
            ...
            <div class="tab-content" style="padding: 0px 60px;">
              <div class="tab-pane fade in active" id="cause">
                          ...
                          <img alt="" src="/images/pathology/plantar-fasciitis.jpg" style="float: right;" /><br />
              ...
              <div class="tab-pane fade" id="treatment">
                  <p><h3>Treatment:</h3><p>
                      ...
                      <p itemprop="possibleTreatment">Also known as NSAID's, this class of drugs helps to decrease the inflammatory process  within the plantar fascia. We frequently use these drugs for a period of several months.</p>
                      <hr>

                      <p><p><span class="label label-primary">Stretching:</span><p></p>
                     
                      <p itemprop="possibletreatment">By stretching the plantar fascia, the abnormal pressure can be alleviated and resolution of the problem obtained. Many times night splints can achieve this goal with minimal pain and inconvenience.</p>
                      <hr>

                      <p><span class="label label-primary">Injections:</span><p>

                      <p itemprop="possibletreatment">Cortisone injections carry potent anti-inflammatory action. They are used for moderate  to severe cases of plantar fasciitis. Plantar fasciitis which does not respond to other  forms of treatment are also an indication for their use.</p>
                      <hr>
                      ...
                      <p itemprop="possibletreatment">Proper fitting and supporting shoe gear is critical is alleviating heel pain. Many times we  place our patients in athletic shoes for prolonged periods. These styles allow more  support to the arch and heel, creating a favorable environment for recovery. </p>
                      <hr>

                      <p><span class="label label-primary">Rest:</span><p>
                      <p itemprop="possibletreatment">In severe cases of heel pain, we ask our patient to take time off work to rest their foot.  This is especially true for people who spend a great deal of time on their feet. This may  be combined with immobilization in a short leg cast.</p>
                      <hr>
                      ...
                      <p>This technology represent the latest innovation in the treatment of resistant plantar  fasciitis. We have been utilizing this modality since January of 2000 with excellent  results. 
                         ...
                         <div class="col-lg-8">
                         <div class="videowrapper"> <iframe width="640" height="360" src="//www.youtube.com/embed/hauyuX-uCq8" frameborder="0" allowfullscreen></iframe></div>
                       <hr>
                        <div class="videowrapper"> <iframe width="640" height="480" src="//www.youtube.com/embed/G6S_a3TELgU" frameborder="0" allowfullscreen></iframe></div>
                       <hr>
                        <div class="videowrapper"> <iframe width="640" height="480" src="//www.youtube.com/embed/J4e-0eKZ98Y" frameborder="0" allowfullscreen></iframe></div>
                       <hr>
                        <div class="videowrapper"> <iframe width="640" height="360" src="//www.youtube.com/embed/tUrkGnRdOhs" frameborder="0" allowfullscreen></iframe></div>
                        </div><!-- videowrapper -->
                        </div><!-- col -->
                        </div><!-- video -->
            </div><!-- tab0content -->
